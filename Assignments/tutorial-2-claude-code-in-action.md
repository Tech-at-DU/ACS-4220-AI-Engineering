# :rocket: Tutorial 2: Claude Code in Action
...
**You already know some of this.** That's the point. This tutorial asks you to compare what you've been doing with what the official workflow recommends — and identify where you can improve.

**External Course:** Choose one:
...
### Part 1 — Complete the Course

- [ ] Work through **all modules** of Claude Code in Action.
- [ ] Complete all quizzes (Coursera path) or review questions (Skilljar path).
- [ ] Take a screenshot of your completion page.
...
|:--|:--|:--|:--|:--|
| **Course Completion** | Incomplete; missing modules | All modules completed | Completed with evidence of engagement (notes, screenshots) | Completed on both platforms; compared experiences |
| **Workflow Audit** | Missing or generic observations | Audit present but surface-level | Specific, honest comparison with concrete examples from own work | Deep analysis; identifies patterns in own workflow habits |
| **New Technique** | No new technique applied | Attempted but incomplete implementation | Successfully applied one new technique with clear documentation | Applied multiple new techniques; measurable workflow improvement |
| **Reflection Quality** | No reflection on changes | Brief mentions of what changed | Thoughtful before/after comparison with specific examples | Demonstrates genuine skill growth; would help a peer improve |
...
- [**Day 05**: Words Before Code](../Lessons/words-before-code.md): Why specifications drive the entire workflow.
- [**Day 06**: Nothing Survives First Contact](../Lessons/nothing-survives-first-contact.md): Testing against the real world.
- [**Day 07**: Somebody Else's Spaghetti](../Lessons/somebody-elses-spaghetti.md): Working with code you didn't write.
- [**Day 08**: House Rules](../Lessons/house-rules.md): Team conventions and linting with AI.

### External

- [Claude Code Documentation](https://docs.anthropic.com/en/docs/claude-code): Official reference.
- [DeepLearning.AI: Claude Code](https://learn.deeplearning.ai/courses/claude-code-a-highly-agentic-coding-assistant/): Companion course for advanced agentic patterns.
